<?php
/**
 * Template Name: Navodila za uporabo
 *
...
<div class="nmn">
  <div class="nmn-wrap">
    ...
    <p class="nmn-sub">Prenesite navodila za svoj izdelek NORIKS v obliki PDF.</p>
    ...
    <div class="nmn-search">
      ...
      <input type="search" id="nmn-q" placeholder="Iskanje po imenu izdelka…" autocomplete="off">
    </div>
          ...
          <div class="nmn-body">
            ...
            <p class="nmn-links">
              <a class="nmn-btn" href="<?php echo esc_url( $dir_url . $m['file'] ); ?>" target="_blank" rel="noopener">
                Prenesi PDF <span>(<?php echo esc_html( $size ); ?>)</span>
              </a>
              <?php if ( $p['url'] ) : ?>
                <a class="nmn-link" href="<?php echo esc_url( $p['url'] ); ?>">Stran izdelka</a>
              <?php endif; ?>
            </p>
          </div>
        </div>
    ...
    <p class="nmn-empty" id="nmn-empty" hidden>Za ta pojem ni navodil. Pišite nam na <a href="mailto:info@noriks.com">info@noriks.com</a>.</p>
    <p class="nmn-help">Potrebujete pomoč pri izdelku? Pišite nam na <a href="mailto:info@noriks.com">info@noriks.com</a>.</p>
  </div>
</div>
