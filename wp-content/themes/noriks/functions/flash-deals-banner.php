...
const NORIKS_FLASH_CAT   = 'poletna-razprodaja';
...
function noriks_flash_deals_banner() {
    ...
    ?>
    <div class="nfd" role="region" aria-label="Poletna razprodaja">
      <div class="nfd-in">
        <div class="nfd-left">
          <p class="nfd-eyebrow">Sezonsko znižanje</p>
          <div class="nfd-head">
            <h2 class="nfd-title">Poletna razprodaja</h2>
            <?php if ( $off > 0 ) : ?>
              <span class="nfd-badge">-&minus;<?php echo (int) $off; ?>%</span>
            <?php endif; ?>
          </div>
          <p class="nfd-sub">Znižano, dokler traja zaloga</p>
        </div>

        <div class="nfd-right">
          <span class="nfd-cta">Ponudba poteče čez</span>
          <div class="nfd-clock" id="nfd-clock" aria-live="off">
            <span class="nfd-unit"><b data-u="d">00</b><em>dni</em></span>
            <span class="nfd-unit"><b data-u="h">00</b><em>ur</em></span>
