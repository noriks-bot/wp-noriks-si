 ...
 *
 * Okvir se prikazuje ODMAH ISPOD gumba "Dodaj u košaricu" i nudi 4x Zelene Boksarice
	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			array(
				...
				'label'        => 'Prikaži upsell pod gumbom (4x Zelene Boksarice)',
			...
			array(
				...
				'label'        => 'Prikaži upsell #3 pod gumbom (NORIKS FIT kompresijska majica)',
				'name'         => 'noriks_pp_upsell3',
				'type'         => 'true_false',
				'instructions' => 'Tretji upsell okvir: NORIKS FIT kompresijska majica, kupec izbere velikost. Neodvisen od prvih dveh stikal.',
				'ui'           => 1,
			),
		),
		'location'   => array(
...
function noriks_pp_upsell_config() {
	return apply_filters( 'noriks_pp_upsell_config', array(
		...
		'title'      => '4x Zelene Boksarice',
		'desc'       => 'Zračne in mehke — dodajte jih k naročilu z %s%% popusta.', // %s = izracunati popust
		'size_attr'  => 'Velikost',
...
function noriks_pp_upsell_render() {
	...
	?>
	<div class="npu-wrap">
		<span class="npu-label">Kupite skupaj in prihranite:</span>
			...
			<div class="npu-grid">
				...
				<div class="npu-actions">
					<label class="npu-check">
						...
						<span class="npu-check-text">Dodaj k nakupu</span>
					</label>

					<select class="npu-size" name="noriks_pp_upsell_size" aria-label="Velikost boksaric">
...
function noriks_pp_upsell2_config() {
	return apply_filters( 'noriks_pp_upsell2_config', array(
		...
		'title'      => '1x Črna + 1x Siva majica',
		'desc'       => 'Dve osnovni majici v paketu — dodajte ju k naročilu z %s%% popusta.',
		'size_attr'  => 'Velikost',
		'sku'        => 'NORIKS-SHIRTS-BLACK-GRAY-2-PACK-UPSELL',
		'image'      => get_template_directory_uri() . '/img/upsell/upsell-2x-majici.png',
		'label'      => 'Kupite skupaj in prihranite:',
		'add_text'   => 'Dodaj k nakupu',
		'aria'       => 'Velikost majic',
	) );
}
...
function noriks_pp_upsell2_maybe_add( $cart_item_key, $product_id, $quantity, $variation_id, $variation, $cart_item_data ) {
	...
	$lines  = array(
		( $prod_a ? $prod_a->get_name() : 'Črna' ) . ' - ' . $size,
		( $prod_b ? $prod_b->get_name() : 'Siva majica' ) . ' - ' . $size,
	);
...
function noriks_pp_upsell3_config() {
	return apply_filters( 'noriks_pp_upsell3_config', array(
		'product_id' => 9066,   // NORIKS FIT kompresijska majica (jednostavan proizvod)
		'total'      => 17.99,  // cijena za 1 komad
		'title'      => 'NORIKS FIT kompresijska majica',
		'desc'       => 'Oblikuje postavo in podpira držo — dodajte jo naročilu z %s%% popusta.',
		'size_attr'  => 'Velikost',
