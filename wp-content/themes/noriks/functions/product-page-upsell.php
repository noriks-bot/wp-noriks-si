	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			array(
				...
				'label'        => 'Prikaži upsell pod gumbom (3x Modre Boksarice)',
				'name'         => 'noriks_pp_upsell',
				'type'         => 'true_false',
				'instructions' => 'Doda okvir "Kupite skupaj in prihranite" takoj pod gumb Dodaj v košarico. Kupec izbere velikost, 3 kosi se dodajo po upsell ceni. Velja samo za ta izdelek.',
				'ui'           => 1,
			),
		),
		'location'   => array(
