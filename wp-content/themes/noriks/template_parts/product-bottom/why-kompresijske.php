...
<!-- Kako deluje v praksi (product demo videos, autoplay on view) — FIRST -->
<section class="why-section knc-demo">
  <div class="knc-demo-wrap">
    <h2 class="knc-demo-title">Kako deluje v praksi</h2>
...
<!-- Primerjava: NORIKS proti ostalim -->
    ...
    <div class="knc-table-scroll">
      <table class="knc-table">
        ...
        <tbody>
          ...
          <tr><td>30-dnevna garancija vračila denarja</td><td class="no">✕</td><td class="no">✕</td><td class="us ok">✓</td></tr>
  ...
  <div style="max-width: 1440px;" class="container why-container">
    ...
    <div class="why-col why-content">
      <h2 style="color: #222; text-align:left; margin-left: 20px; font-family: 'Barlow', sans-serif; color:#222223;">
        ZAKAJ KOMPRESIJSKE NOGAVICE?
      </h2>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Boljša cirkulacija, manj utrujenosti</strong></p>
        <p class="description">Postopna kompresija nežno spodbuja pretok krvi proti srcu, zmanjša občutek teže in utrujenosti v nogah ter pomaga, da noge ostanejo lahke tudi ob najdaljšem dnevu.</p>
      </div>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Manj otekanja</strong></p>
        <p class="description">Idealne za dolga potovanja, dolgo stanje ali sedenje. Enakomeren pritisk zmanjša zadrževanje tekočine ter otekanje gležnjev in meč.</p>
      </div>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Opora, ki se čuti</strong></p>
        <p class="description">Anatomski kroj drži nogavico na mestu, brez stiskanja na vrhu. Občutek trdne, a udobne opore ves dan.</p>
      </div>
    </div>
...
<!-- Kaj pravijo naši kupci (UGC testimonial videos, load on click) -->
<section class="why-section knc-ugc">
  <div class="knc-ugc-wrap">
    <h2 class="knc-ugc-title">Kaj pravijo naši kupci</h2>
    <div class="knc-ugc-grid">
      <div class="knc-ugc-item" data-src="<?php echo esc_url( $knv ); ?>review-1.mp4"><video class="knc-ugc-video" poster="<?php echo esc_url( $knv ); ?>review-1-poster.jpg" preload="none" playsinline></video><span class="knc-ugc-play" aria-label="Predvajaj"></span></div>
      <div class="knc-ugc-item" data-src="<?php echo esc_url( $knv ); ?>review-2.mp4"><video class="knc-ugc-video" poster="<?php echo esc_url( $knv ); ?>review-2-poster.jpg" preload="none" playsinline></video><span class="knc-ugc-play" aria-label="Predvajaj"></span></div>
      <div class="knc-ugc-item" data-src="<?php echo esc_url( $knv ); ?>review-3.mp4"><video class="knc-ugc-video" poster="<?php echo esc_url( $knv ); ?>review-3-poster.jpg" preload="none" playsinline></video><span class="knc-ugc-play" aria-label="Predvajaj"></span></div>
    </div>
  </div>
</section>
